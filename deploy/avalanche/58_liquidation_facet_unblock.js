...
/**
 * MINIMAL unblock for stuck liquidations (branch: fix/insolvency-snapshot-rearm-window) — Avalanche.
 *
 ...
 * in 57_insolvency_snapshot_rearm_facets.js and is not required to unblock liquidations.
 *
 * PREREQUISITE: the working tree must have its DeploymentConstants imports pointed at Avalanche
 * (the standard updateConstants('avalanche') step) before running — this facet imports the
...
module.exports = async ({ getNamedAccounts, deployments }) => {
    ...
    console.log("== Avalanche minimal liquidation-unblock redeploy (SmartLoanLiquidationFacet) ==");
    ...
    console.log("\n== Deploy summary (Avalanche minimal liquidation-unblock) ==");
...
module.exports.tags = ["avalanche-liquidation-facet-unblock"];
