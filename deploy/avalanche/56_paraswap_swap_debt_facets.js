...
/**
 * ParaSwapFacet + SwapDebtFacet redeploy — Avalanche.
 *
 * Deploys fresh implementations of both ParaSwap-related facets, then writes a
 * verify manifest and runs block-explorer (Routescan, which snowtrace.io reads)
 * + Tenderly verification for each one.
 *
 ...
 * deployments/avalanche/paraswap-swap-debt-facets.verify-manifest.json, and
...
module.exports = async ({ getNamedAccounts, deployments }) => {
    ...
    console.log("== Avalanche ParaSwapFacet + SwapDebtFacet redeploy ==");
    ...
    // Block-explorer (Routescan) verification. verifyDeployment submits the exact
    // saved solc input as a minimal closure and reads any library link from the
    // deployment artifact — immune to working-tree drift and solc-wasm OOM.
    ...
    console.log("\n== Deploy summary (Avalanche ParaSwapFacet + SwapDebtFacet) ==");
...
module.exports.tags = ["avalanche-paraswap-swap-debt-facets"];
